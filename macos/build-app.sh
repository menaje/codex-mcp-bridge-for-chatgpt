...
cp "$repository_root/release-manifest.schema.json" "$runtime_directory/"
cp "$repository_root/ui-release-catalog.json" "$runtime_directory/"
cp "$repository_root/state-migrations.json" "$runtime_directory/"
