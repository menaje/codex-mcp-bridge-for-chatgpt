...
final class SettingsConnectionPresentationTests: XCTestCase {
    ...
    func testProductionSettingsUsesSidebarAndSeparateDraftDestinations() throws {
        ...
        XCTAssertTrue(source.contains("columnVisibility"))
        ...
        XCTAssertFalse(source.contains("SettingsTitlebarSanitizerView"))
        XCTAssertTrue(source.contains("navigationSplitView.toggleSidebar"))
        XCTAssertFalse(source.contains("splitViewSeparator"))
        XCTAssertFalse(source.contains("item.view?.isHidden = true"))
        ...
        XCTAssertTrue(source.contains("SettingsToolbarCleanup"))
        XCTAssertTrue(source.contains("settings-sidebar-toggle"))
    ...
    func testSettingsWindowKeepsTheLocalizedTitleAndOriginalUnifiedToolbar() throws {
        ...
        XCTAssertFalse(application.contains("settingsWindow.titleVisibility = .hidden"))
        XCTAssertTrue(application.contains("settingsWindow.toolbarStyle = .unified"))
