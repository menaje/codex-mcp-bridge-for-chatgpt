...
export const SETTINGS_CARD_URI = `ui://${PRODUCT_INFO.runtimeName}/settings-v10.html`;
...
<body>
  ...
  <script>
    ...
    const elements = { form:byId("settings-form"),access:byId("access-strategy"),accessHint:byId("access-hint"),model:byId("default-model"),effort:byId("default-effort"),cwd:byId("default-cwd"),roots:byId("allowed-roots"),cwdHint:byId("cwd-hint"),language:byId("ui-language"),concurrency:byId("concurrency"),cardVisibility:byId("activity-card-visibility"),handoff:byId("completion-handoff"),handoffHint:byId("handoff-hint"),save:byId("save"),refresh:byId("refresh"),reset:byId("reset"),status:byId("status"),fullWarning:byId("full-warning"),catalogWarning:byId("catalog-warning") };
