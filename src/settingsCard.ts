...
export const SETTINGS_CARD_CONTRACT_GENERATION = 21;
...
export const SETTINGS_CARD_CONTENT_METADATA = {
  ...
  "openai/widgetDescription":
    `Configure named projects, saved access, model/effort policy, Codex-app thread visibility, automatic Dashboard display, macOS completion notifications, interface-language, and concurrency for ${PRODUCT_INFO.displayName}.`,
  ...
  <main class="card">
    ...
    <form id="settings-form" hidden>
      <div class="grid">
        ...
        <div class="wide"><label class="checkline"><input id="dashboard-auto-open" type="checkbox" /><span data-i18n="settings.dashboardAutoOpen"></span></label><span class="hint" data-i18n="settings.dashboardAutoOpenHint"></span></div>
