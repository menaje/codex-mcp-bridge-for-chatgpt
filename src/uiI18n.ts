...
import { MODEL_DESCRIPTION_TRANSLATIONS } from "./modelDescriptionI18n.js";
...
const ENGLISH = {
  ...
  ...MODEL_DESCRIPTION_TRANSLATIONS.en,
  ...
  "settings.unsupportedEffort": "The saved reasoning level is no longer supported. Suggested model default:", "effort.minimal.description": "Fastest responses with only essential reasoning.", "effort.low.description": "Quick responses with lighter reasoning.", "effort.medium.description": "Balanced reasoning depth and response time.", "effort.high.description": "Deeper review for complex work with a longer response time.", "effort.xhigh.description": "Very deep reasoning for difficult tasks; responses can take substantially longer.", "effort.max.description": "Maximum available reasoning depth for demanding work.", "effort.ultra.description": "Extended reasoning and delegation for the most demanding work.",
  ...
  "agent.idle": "Idle", "agent.active": "Active", "agent.waiting-input": "Waiting for input", "agent.orphaned": "Thread unavailable",
...
const ISSUE19_OVERRIDES: Record<Exclude<SupportedUiLocale, "en">, Partial<UiTranslationBundle>> = {
  ko: {
    "settings.effortFallbackDescription": "현재 Codex 모델 카탈로그에서 제공된 새 추론 단계입니다.", "settings.unsupportedEffort": "저장된 추론 단계는 더 이상 지원되지 않습니다. 권장 모델 기본값:", "effort.minimal.description": "필수 추론만 사용해 가장 빠르게 응답합니다.", "effort.low.description": "가벼운 추론으로 빠르게 응답합니다.", "effort.medium.description": "추론 깊이와 응답 시간의 균형을 맞춥니다.", "effort.high.description": "복잡한 작업을 더 깊게 검토하지만 응답 시간이 늘어날 수 있습니다.", "effort.xhigh.description": "어려운 작업을 매우 깊게 추론하므로 응답이 상당히 오래 걸릴 수 있습니다.", "effort.max.description": "까다로운 작업에 사용할 수 있는 최대 추론 깊이입니다.", "effort.ultra.description": "가장 까다로운 작업을 위해 확장 추론과 위임을 사용합니다.",
    "activity.agents": "Codex 에이전트", "activity.noAgents": "이 대화에는 아직 Codex 에이전트가 없습니다.", "activity.idleAgents": "대기 중인 에이전트", "activity.temporaryJob": "에이전트 시작 중", "activity.currentActivity": "현재 Activity", "activity.elapsed": "경과 시간", "activity.lastChanged": "마지막 변경", "activity.showMore": "더 보기", "activity.rename": "이름 변경", "activity.detach": "Activity에서 해제", "activity.renamePrompt": "새 에이전트 이름을 입력하세요.", "activity.backgroundProcesses": "백그라운드 프로세스 실행 중", "activity.agentId": "에이전트 ID",
    "agent.idle": "유휴", "agent.active": "실행 중", "agent.waiting-input": "입력 대기", "agent.orphaned": "스레드 사용 불가"
  },
  ja: {
    "settings.effortFallbackDescription": "現在の Codex モデルカタログで提供される新しい推論レベルです。", "settings.unsupportedEffort": "保存済みの推論レベルはサポートされなくなりました。推奨されるモデル既定値:", "effort.minimal.description": "必要最小限の推論で最速に応答します。", "effort.low.description": "軽い推論で素早く応答します。", "effort.medium.description": "推論の深さと応答時間のバランスを取ります。", "effort.high.description": "複雑な作業を深く検討しますが応答時間が長くなる場合があります。", "effort.xhigh.description": "難しい作業を非常に深く推論するため、応答にかなり時間がかかる場合があります。", "effort.max.description": "要求の高い作業に利用できる最大の推論深度です。", "effort.ultra.description": "最も難しい作業に拡張推論と委任を使用します。",
    "activity.agents": "Codex エージェント", "activity.noAgents": "この会話にはまだ Codex エージェントがありません。", "activity.idleAgents": "待機中のエージェント", "activity.temporaryJob": "エージェントを開始中", "activity.currentActivity": "現在の Activity", "activity.elapsed": "経過時間", "activity.lastChanged": "最終変更", "activity.showMore": "さらに表示", "activity.rename": "名前を変更", "activity.detach": "Activity から解除", "activity.renamePrompt": "新しいエージェント名を入力してください。", "activity.backgroundProcesses": "バックグラウンドプロセス実行中", "activity.agentId": "エージェント ID", "agent.idle": "待機中", "agent.active": "実行中", "agent.waiting-input": "入力待ち", "agent.orphaned": "スレッド利用不可"
  },
  "zh-Hans": {
    "settings.effortFallbackDescription": "这是当前 Codex 模型目录提供的新推理级别。", "settings.unsupportedEffort": "已保存的推理级别不再受支持。建议的模型默认值：", "effort.minimal.description": "仅使用必要推理，响应最快。", "effort.low.description": "使用较轻推理快速响应。", "effort.medium.description": "平衡推理深度和响应时间。", "effort.high.description": "更深入检查复杂任务，但响应可能更慢。", "effort.xhigh.description": "对困难任务进行非常深入的推理，响应可能明显更慢。", "effort.max.description": "为高难度任务提供最大推理深度。", "effort.ultra.description": "为最困难的任务使用扩展推理和委派。", "activity.agents": "Codex 代理", "activity.noAgents": "此对话中还没有 Codex 代理。", "activity.idleAgents": "空闲代理", "activity.temporaryJob": "正在启动代理", "activity.currentActivity": "当前 Activity", "activity.elapsed": "已用时间", "activity.lastChanged": "最后更改", "activity.showMore": "显示更多", "activity.rename": "重命名", "activity.detach": "从 Activity 分离", "activity.renamePrompt": "输入新的代理名称。", "activity.backgroundProcesses": "后台进程仍在运行", "activity.agentId": "代理 ID", "agent.idle": "空闲", "agent.active": "活动", "agent.waiting-input": "等待输入", "agent.orphaned": "线程不可用"
  },
  "zh-Hant": {
    "settings.effortFallbackDescription": "這是目前 Codex 模型目錄提供的新推理層級。", "settings.unsupportedEffort": "已儲存的推理層級已不再支援。建議的模型預設值：", "effort.minimal.description": "只使用必要推理，回應最快。", "effort.low.description": "以較輕量的推理快速回應。", "effort.medium.description": "平衡推理深度與回應時間。", "effort.high.description": "更深入檢查複雜工作，但回應可能較慢。", "effort.xhigh.description": "對困難工作進行非常深入的推理，回應可能明顯較慢。", "effort.max.description": "為高難度工作提供最大的推理深度。", "effort.ultra.description": "為最困難的工作使用擴充推理與委派。", "activity.agents": "Codex 代理程式", "activity.noAgents": "此對話中尚無 Codex 代理程式。", "activity.idleAgents": "閒置代理程式", "activity.temporaryJob": "正在啟動代理程式", "activity.currentActivity": "目前 Activity", "activity.elapsed": "經過時間", "activity.lastChanged": "最後變更", "activity.showMore": "顯示更多", "activity.rename": "重新命名", "activity.detach": "從 Activity 卸離", "activity.renamePrompt": "輸入新的代理程式名稱。", "activity.backgroundProcesses": "背景程序仍在執行", "activity.agentId": "代理程式 ID", "agent.idle": "閒置", "agent.active": "執行中", "agent.waiting-input": "等待輸入", "agent.orphaned": "執行緒無法使用"
  },
  es: {
    "settings.effortFallbackDescription": "Un nuevo nivel de razonamiento ofrecido por el catálogo actual de Codex.", "settings.unsupportedEffort": "El nivel guardado ya no es compatible. Valor predeterminado sugerido:", "effort.minimal.description": "Respuesta más rápida con solo el razonamiento esencial.", "effort.low.description": "Respuestas rápidas con razonamiento ligero.", "effort.medium.description": "Equilibra profundidad de razonamiento y tiempo de respuesta.", "effort.high.description": "Revisión más profunda para tareas complejas, con mayor tiempo de respuesta.", "effort.xhigh.description": "Razonamiento muy profundo para tareas difíciles; puede tardar bastante más.", "effort.max.description": "Máxima profundidad de razonamiento disponible para tareas exigentes.", "effort.ultra.description": "Razonamiento ampliado y delegación para las tareas más exigentes.", "activity.agents": "Agentes Codex", "activity.noAgents": "Aún no hay agentes Codex en esta conversación.", "activity.idleAgents": "Agentes inactivos", "activity.temporaryJob": "Iniciando agente", "activity.currentActivity": "Activity actual", "activity.elapsed": "Transcurrido", "activity.lastChanged": "Último cambio", "activity.showMore": "Mostrar más", "activity.rename": "Cambiar nombre", "activity.detach": "Desvincular de Activity", "activity.renamePrompt": "Introduce un nuevo nombre de agente.", "activity.backgroundProcesses": "Procesos en segundo plano activos", "activity.agentId": "ID de agente", "agent.idle": "Inactivo", "agent.active": "Activo", "agent.waiting-input": "Esperando entrada", "agent.orphaned": "Hilo no disponible"
  },
  fr: {
    "settings.effortFallbackDescription": "Un nouveau niveau de raisonnement fourni par le catalogue Codex actuel.", "settings.unsupportedEffort": "Le niveau enregistré n’est plus pris en charge. Valeur par défaut suggérée :", "effort.minimal.description": "Réponse la plus rapide avec le raisonnement essentiel uniquement.", "effort.low.description": "Réponses rapides avec un raisonnement léger.", "effort.medium.description": "Équilibre profondeur du raisonnement et temps de réponse.", "effort.high.description": "Examen approfondi des tâches complexes, avec un temps de réponse accru.", "effort.xhigh.description": "Raisonnement très approfondi pour les tâches difficiles ; la réponse peut être nettement plus longue.", "effort.max.description": "Profondeur de raisonnement maximale pour les tâches exigeantes.", "effort.ultra.description": "Raisonnement étendu et délégation pour les tâches les plus exigeantes.", "activity.agents": "Agents Codex", "activity.noAgents": "Aucun agent Codex dans cette conversation.", "activity.idleAgents": "Agents inactifs", "activity.temporaryJob": "Démarrage de l’agent", "activity.currentActivity": "Activity actuelle", "activity.elapsed": "Durée", "activity.lastChanged": "Dernière modification", "activity.showMore": "Afficher plus", "activity.rename": "Renommer", "activity.detach": "Détacher de l’Activity", "activity.renamePrompt": "Saisissez un nouveau nom d’agent.", "activity.backgroundProcesses": "Processus en arrière-plan actifs", "activity.agentId": "ID de l’agent", "agent.idle": "Inactif", "agent.active": "Actif", "agent.waiting-input": "En attente de saisie", "agent.orphaned": "Thread indisponible"
  },
  de: {
    "settings.effortFallbackDescription": "Eine neue Reasoning-Stufe aus dem aktuellen Codex-Modellkatalog.", "settings.unsupportedEffort": "Die gespeicherte Reasoning-Stufe wird nicht mehr unterstützt. Empfohlener Modellstandard:", "effort.minimal.description": "Schnellste Antworten mit nur dem nötigen Reasoning.", "effort.low.description": "Schnelle Antworten mit leichtem Reasoning.", "effort.medium.description": "Ausgewogenes Verhältnis von Reasoning-Tiefe und Antwortzeit.", "effort.high.description": "Tiefere Prüfung komplexer Aufgaben mit längerer Antwortzeit.", "effort.xhigh.description": "Sehr tiefes Reasoning für schwierige Aufgaben; Antworten können deutlich länger dauern.", "effort.max.description": "Maximale verfügbare Reasoning-Tiefe für anspruchsvolle Aufgaben.", "effort.ultra.description": "Erweitertes Reasoning und Delegation für besonders anspruchsvolle Aufgaben.", "activity.agents": "Codex-Agenten", "activity.noAgents": "Noch keine Codex-Agenten in dieser Unterhaltung.", "activity.idleAgents": "Inaktive Agenten", "activity.temporaryJob": "Agent wird gestartet", "activity.currentActivity": "Aktuelle Activity", "activity.elapsed": "Vergangen", "activity.lastChanged": "Letzte Änderung", "activity.showMore": "Mehr anzeigen", "activity.rename": "Umbenennen", "activity.detach": "Von Activity lösen", "activity.renamePrompt": "Geben Sie einen neuen Agentennamen ein.", "activity.backgroundProcesses": "Hintergrundprozesse laufen", "activity.agentId": "Agenten-ID", "agent.idle": "Inaktiv", "agent.active": "Aktiv", "agent.waiting-input": "Wartet auf Eingabe", "agent.orphaned": "Thread nicht verfügbar"
  },
  pt: {
    "settings.effortFallbackDescription": "Um novo nível de raciocínio fornecido pelo catálogo atual do Codex.", "settings.unsupportedEffort": "O nível salvo não é mais compatível. Padrão sugerido do modelo:", "effort.minimal.description": "Resposta mais rápida usando apenas o raciocínio essencial.", "effort.low.description": "Respostas rápidas com raciocínio leve.", "effort.medium.description": "Equilibra profundidade de raciocínio e tempo de resposta.", "effort.high.description": "Revisão mais profunda de tarefas complexas, com maior tempo de resposta.", "effort.xhigh.description": "Raciocínio muito profundo para tarefas difíceis; a resposta pode demorar bem mais.", "effort.max.description": "Profundidade máxima de raciocínio para tarefas exigentes.", "effort.ultra.description": "Raciocínio ampliado e delegação para as tarefas mais exigentes.", "activity.agents": "Agentes Codex", "activity.noAgents": "Ainda não há agentes Codex nesta conversa.", "activity.idleAgents": "Agentes ociosos", "activity.temporaryJob": "Iniciando agente", "activity.currentActivity": "Activity atual", "activity.elapsed": "Decorrido", "activity.lastChanged": "Última alteração", "activity.showMore": "Mostrar mais", "activity.rename": "Renomear", "activity.detach": "Desvincular da Activity", "activity.renamePrompt": "Digite um novo nome para o agente.", "activity.backgroundProcesses": "Processos em segundo plano ativos", "activity.agentId": "ID do agente", "agent.idle": "Ocioso", "agent.active": "Ativo", "agent.waiting-input": "Aguardando entrada", "agent.orphaned": "Thread indisponível"
  }
};
...
const ISSUE41_OVERRIDES: Record<Exclude<SupportedUiLocale, "en">, Partial<UiTranslationBundle>> = {
  ko: {
    "activity.allActivities": "전체 Activity", "activity.pastRecords": "지난 기록", "activity.completedActivities": "완료 작업", "activity.endedActivities": "종료 작업", "activity.idleAgentCount": "유휴 Agent", "activity.history": "최근 활동", "activity.noHistory": "이 대화에는 지난 Activity가 없습니다.", "activity.previousPage": "이전", "activity.nextPage": "다음"
  },
  ja: {
    "activity.allActivities": "すべてのアクティビティ", "activity.pastRecords": "過去の記録", "activity.completedActivities": "完了", "activity.endedActivities": "終了", "activity.idleAgentCount": "待機中のエージェント", "activity.history": "最近のアクティビティ", "activity.noHistory": "この会話には過去のアクティビティがありません。", "activity.previousPage": "前へ", "activity.nextPage": "次へ"
  },
  "zh-Hans": {
    "activity.allActivities": "所有活动", "activity.pastRecords": "历史记录", "activity.completedActivities": "已完成", "activity.endedActivities": "已结束", "activity.idleAgentCount": "空闲代理", "activity.history": "最近活动", "activity.noHistory": "此对话中没有历史活动。", "activity.previousPage": "上一页", "activity.nextPage": "下一页"
  },
  "zh-Hant": {
    "activity.allActivities": "所有活動", "activity.pastRecords": "歷史記錄", "activity.completedActivities": "已完成", "activity.endedActivities": "已結束", "activity.idleAgentCount": "閒置代理程式", "activity.history": "近期活動", "activity.noHistory": "此對話中沒有歷史活動。", "activity.previousPage": "上一頁", "activity.nextPage": "下一頁"
  },
  es: {
    "activity.allActivities": "Todas las actividades", "activity.pastRecords": "Historial", "activity.completedActivities": "Completadas", "activity.endedActivities": "Finalizadas", "activity.idleAgentCount": "Agentes inactivos", "activity.history": "Actividad reciente", "activity.noHistory": "No hay actividades anteriores en esta conversación.", "activity.previousPage": "Anterior", "activity.nextPage": "Siguiente"
  },
  fr: {
    "activity.allActivities": "Toutes les activités", "activity.pastRecords": "Historique", "activity.completedActivities": "Terminées", "activity.endedActivities": "Arrêtées", "activity.idleAgentCount": "Agents inactifs", "activity.history": "Activité récente", "activity.noHistory": "Aucune activité antérieure dans cette conversation.", "activity.previousPage": "Précédent", "activity.nextPage": "Suivant"
  },
  de: {
    "activity.allActivities": "Alle Aktivitäten", "activity.pastRecords": "Verlauf", "activity.completedActivities": "Abgeschlossen", "activity.endedActivities": "Beendet", "activity.idleAgentCount": "Inaktive Agenten", "activity.history": "Letzte Aktivität", "activity.noHistory": "In dieser Unterhaltung gibt es keine früheren Aktivitäten.", "activity.previousPage": "Zurück", "activity.nextPage": "Weiter"
  },
  pt: {
    "activity.allActivities": "Todas as atividades", "activity.pastRecords": "Histórico", "activity.completedActivities": "Concluídas", "activity.endedActivities": "Encerradas", "activity.idleAgentCount": "Agentes ociosos", "activity.history": "Atividade recente", "activity.noHistory": "Não há atividades anteriores nesta conversa.", "activity.previousPage": "Anterior", "activity.nextPage": "Próxima"
  }
};
