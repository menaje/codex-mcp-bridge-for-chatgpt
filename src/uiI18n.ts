...
const REMAINDER: Record<Exclude<SupportedUiLocale, "en" | "ko">, Partial<UiTranslationBundle>> = {
  ja: {
    ...
    "settings.delivery.auto": "カード表示中に GPT へ自動引き継ぎ",
    "settings.saving": "保存中…",
  ...
  "zh-Hans": {
    ...
    "settings.delivery.auto": "卡片打开时自动交接给 GPT",
  ...
  "zh-Hant": {
    ...
    "settings.delivery.auto": "卡片開啟時自動交接給 GPT",
    "settings.saving": "儲存中…",
    "settings.saved": "已儲存。",
  ...
  es: {
    ...
    "settings.delivery.auto": "Entrega automática a GPT mientras la tarjeta esté abierta",
  ...
  fr: {
    ...
    "settings.delivery.auto": "Transfert automatique à GPT tant que la carte est ouverte",
  ...
  de: {
    ...
    "settings.delivery.auto": "Automatische GPT-Übergabe bei geöffneter Karte",
  ...
  pt: {
    ...
    "settings.delivery.auto": "Entrega automática ao GPT enquanto o cartão estiver aberto",
