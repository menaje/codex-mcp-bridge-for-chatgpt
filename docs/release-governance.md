...
| Tool/runtime contracts | Task input contract 5, helper protocol 2, local companion protocol 5, remote companion protocol 3, execution-policy references, App Server schema lock and pinned Codex CLI | Independent protocol and state axes |
