...
14. upgrade a schema-17 fixture containing archived idle, active, waiting and orphaned Agents; confirm schema 18 restores all of them with the same IDs, links, records, results, reviews and timestamps, then confirm restart is idempotent and a retained archive/restore request fails without mutation;
