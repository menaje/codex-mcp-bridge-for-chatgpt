...
> **R2 정정:** 이 문서는 schema 22 당시 구현과 실환경 관측 기록을 보존한다.
> `result-read`를 실제 GPT 수신 확인으로 해석하고 직접 조회로 live-card 전달을
> 소비한 부분은 후속 검토에서 과도한 보장으로 판정했다. 현재 계약과 보완
> 검증은 [#126 R2 전달 확실성 및 #128 재시작 보존](./2026-09-18-issue-126-r2-delivery-certainty.md)을 따른다.
